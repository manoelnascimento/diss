\begin{table}[!htp]
\IBGEtab{
\caption{Engenheiros atuantes em Brotas e suas obras, por grupo de logradouros (parte 1)}\label{tab:engenheiros1}}
{
...
\begin{table}[!htp]
\IBGEtab{
\caption{Engenheiros atuantes em Brotas e suas obras, por grupo de logradouros (parte 2)}\label{tab:engenheiros2}}
{
% \begin{minipage}[c][0.8\textheight][c]{\textwidth}
% \begin{tiny}
\begin{tabular}{lllllllllllll}
