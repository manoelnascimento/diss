...
% ---
\input{8-anexos/texto/documentos}
...
\input{8-anexos/texto/mapas.tex}

% ---
\chapter{Plantas selecionadas de casas térreas}
% ---

\input{8-anexos/plantas/01-casaterrea}

% ---
\chapter{Plantas selecionadas de casas de andar}
% ---

\input{8-anexos/plantas/02-casadeandar}

% ---
\chapter{Plantas selecionadas de casas de taipa}
% ---

\input{8-anexos/plantas/03-casadetaipa}

% ---
\chapter{Plantas selecionadas de casas de fazenda}
% ---

\input{8-anexos/plantas/04-casadefazenda}

% ---
\chapter{Plantas selecionadas de casa comercial}
% ---

\input{8-anexos/plantas/05-casacomercial}

% ---
\chapter{Plantas selecionadas de casas mistas (comerciais e residenciais)}
% ---

\input{8-anexos/plantas/06-casamista}

% ---
\chapter{Plantas selecionadas de ``casas para operários''}
% ---

\input{8-anexos/plantas/07-casaparaoperarios}

% ---
\chapter{Plantas selecionadas de casas de praia}\label{cap:anexosamaralina}
% ---

\input{8-anexos/plantas/08-casadepraia}

% ---
\chapter{Plantas selecionadas de disputas de terras}
% ---

\input{8-anexos/plantas/09-disputadeterras}

% ---
% \chapter{Plantas selecionadas de reformas}
% ---

% \input{8-anexos/plantas/10-reformas}

% ---
\chapter{Alguns imóveis ainda de pé}
% ---

\input{8-anexos/plantas/11-casasdepe}

% ---
% \chapter{Algumas plantas destacadas}
% ---

% \input{8-anexos/plantas/12-curiosidades}
