...
Por volta das últimas décadas do século XVIII o traficante de escravos Manuel José Machado mandou construir o \textit{Solar Boa Vista}, com torre alta o suficiente para acompanhar a chegada de navios ao porto de Salvador \cite[p.~127]{mattos_panorama_2011}.

Em agosto de 1869, o governo da Bahia comprou o imóvel, com base na Lei provincial nº 1.089, para a instalação de um hospital. Em 24 de junho de 1874, foi inaugurado, no local, o Asilo São João de Deus, com um hospital, sob a responsabilidade da Santa Casa de Misericórdia.
...
É a precursora do templo homônimo existente ainda hoje no Largo dos Paranhos, na bifurcação entre o Matatu e Cosme de Farias. Pouco há de informações sobre ela, sabendo-se apenas que foi construída em meados do século XIX em estilo neoclássico, que em abril de 1889 encontrava-se em ruínas \footnote{\textbf{Treze de Maio}, 01 abr. 1889, p. 3}, e que sua forma atual resulta de reforma realizada em 1954. 
...
\subsubsection{Armações do Saraiva e do Gregório}
