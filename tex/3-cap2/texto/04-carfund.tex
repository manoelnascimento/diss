...
\subsection{O morgado da Nisa, o morgado da Foz e o latifúndio de Tomás da Silva Paranhos}\label{subsec:paranhos}
...
\subsection{Largo do Paranhos, Pitangueiras, Castro Neves, Sangradouro e Ladeira do Fabrício: urbanização acelerada e enobrecimento a pulso}\label{subsec:pitangueiras}
...
Do saneamento na Mariquita dizia-se que ``não ha anno algum em que não appareçam alli febres de máu caracter, porque as aguas em alguns logares não teem a correntesa necessaria, por accumulação de folhas podres e outros obstaculos'' \cite[p.~20]{bahia_relatassleg_1873}.
