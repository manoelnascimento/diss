...
\  %espaco separador
\subfloat[Atualmente. \textbf{Fonte:} elaboração do autor, com base em Google Earth.]{
...
Outro indício são as terras registradas em nome de Maria Joana da Conceição Simões, a Viscondessa do Rio Vermelho \cite[p.~693]{zuquete_nobreza_1989}:
