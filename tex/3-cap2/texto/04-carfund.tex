...
% }
\  %espaco separador
% \subfloat[Prédio atual, datada de 1953. (\textbf{Fonte:} www.hges.eb.mil.br)]{
...
A porta de entrada para o Matatu, no sentido de quem vem da ladeira dos Galés, é o \textit{largo do Paranhos}, assim batizado em homenagem ao já mencionado latifundiário Tomás da Silva Paranhos (cf. \autoref{subsec:nisa}, p. \pageref{subsec:nisa}).
...
% \begin{sidewaysfigure}[!htp]
% \centering
% \includegraphics[width=1\textwidth]{3-cap2/complementos/mapas/georreferenciamento/boavista/boavista-sangradouro-2016.eps}{\footnotesize \par \textbf{Fonte:} Elaboração do autor com imagem do Open Street Maps. Respeitou-se o traçado de \citeonline{weyll_mappa_1851}. \par}
...
% \begin{sidewaysfigure}[!htp]
% entering
% \includegraphics[width=0.9\textwidth]{3-cap2/complementos/mapas/apcs1955-f32-engvbro.eps}{\footnotesize \par \textbf{Fonte:} \citeonline{municipal_atlas_1955}. O Engenho Velho de Brotas é a área acima do Dique do Tororó. \par}
...
O ``moinho do Dique'' era mencionado num relatório provincial de 1874 \cite[p.~26]{bahia_rpe_1874b}
...
Nada há qualquer registro sobre a Cruz da Redenção nos almanaques consultados, indício da baixa presença na localidade de serviços urbanos, de residências de funcionários públicos ou de escritórios, consultórios e oficinas.
...
\subsection{A Estrada Dois de Julho: elefante branco ou ermo dos pobres?}
...
A \textit{estrada Dois de Julho}, hoje conhecida como \textit{avenida Vasco da Gama}, foi inaugurada em 1859 como caminho alternativo entre o arrabalde do Rio Vermelho e a zona urbana de Salvador; seu trajeto corre rente ao rio Lucaia, desde sua nascente no Dique do Tororó até as vizinhanças da sua foz, no Rio Vermelho \cite[p.~582]{ruy_politica_1949}.
...
% \begin{sidewaysfigure}[!htp]
% \centering
% \includegraphics[width=1\textwidth]{3-cap2/complementos/mapas/georreferenciamento/acupe/acupe-2016.eps}{\footnotesize \par \textbf{Fonte:} Elaboração do autor com imagem do Open Street Maps. Respeitou-se o traçado de \citeonline{weyll_mappa_1851}. \par}
...
\subsection{O Engenho Campinas e as terras dos Ladislau: herdades e negócios de família}\label{subsec:campinasladislau}
...
% \begin{sidewaysfigure}[!htp]
% \centering
% \includegraphics[width=1\textwidth]{3-cap2/complementos/mapas/georreferenciamento/campinas/campinas-1851.eps}{\footnotesize \par \textbf{Fonte:} \citeonline{weyll_mappa_1851}. \par}
...
% \begin{sidewaysfigure}[!htp]
% \centering
% \includegraphics[width=1\textwidth]{3-cap2/complementos/mapas/georreferenciamento/campinas/campinas-2016.eps}{\footnotesize \par \textbf{Fonte:} Elaboração do autor com imagem do Open Street Maps. Respeitou-se o traçado de \citeonline{weyll_mappa_1851}. \par}
