...
Outro aspecto notável, a ser visto em maiores detalhes na \autoref{subsubsec:pitangueiras} (p. \pageref{subsubsec:pitangueiras}) é que o palacete de Joaquim José de Oliveira foi adquirido pela província da Bahia em 1872 para a construção do \textit{Hospital Militar}, que ainda funciona no mesmo local depois de uma reforma completa realizada em 1953.
...
\subsubsection{Pitangueiras e Castro Neves: enobrecimento a pulso}\label{subsubsec:pitangueiras}
...
Não é de espantar, pois as casas no Castro Neves eram muito bem constituídas, como se vê por este exemplo, retirado do leiloamento da propriedade de Firmo Lopo da Silva:
...
Não é de espantar que o Castro Neves fosse ponto concorrido dos festejos do Dois de Julho:
