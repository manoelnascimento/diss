...
Outro ponto onde os processos de valorização imobiliária mostravam-se com toda força era o \textit{Sangradouro}.

Curiosamente, o Sangradouro havia sido no primeiro terço do século XIX
...
Veja-se a descrição de uma casa no Sangradouro num anúncio de 1877:
...
Outro exemplo, de 1878:

\begin{citacao}
\textbf{CASA A VENDA}
Na ladeira da Glória, no Sangradouro, d'esta cidade, vende-se uma excellente 
\end{citacao}

Vê-se assim processo similar ao ocorrido no Castro Neves. 
...
Mas e os moradores de suas margens? Onde estão? Sequer a documentação pesquisada foi capaz de indicar um só que fosse. Resta conjecturar sobre este fato e levantar hipóteses a partir das características físicas do rio Lucaia e de seu entorno. 
