...
% \centering
% \includegraphics[width=\textwidth]{3-cap2/complementos/mapas/joaquim/joaquim02.jpg} 
% \caption{\footnotesize Título e especificações. \textbf{Fonte:} \textbf{BR BAAPB}, Biblioteca, planta 107.}
% \label{fig:joaquim02}
% \end{subfigure}
% 
% \begin{subfigure}[b]{\textwidth}
% \centering
% \includegraphics[width=\textwidth]{3-cap2/complementos/mapas/joaquim/joaquim04.jpg} 
% \caption{\footnotesize Data e autoria. \textbf{Fonte:} \textbf{BR BAAPB}, Biblioteca, planta 107}
% \label{fig:joaquim04}
% \end{subfigure}
% \end{minipage}
% \hfill
...
% \begin{subfigure}[b]{\textwidth}
% \centering
\includegraphics[width=\textwidth]{3-cap2/complementos/mapas/joaquim/joaquim01.jpg}{\footnotesize \par \textbf{Fonte:} \textbf{BR BAAPB}, Biblioteca, planta 107. \par \par A ladeira ``entre a baixa da Fonte nova e o Hospital Militar'' corresponde à atual ladeira dos Galés. Da esquerda para a direita, ela desce reta a encosta, faz esquina com a rua do Castro Neves (homônima à atual) e, depois de encontrar com a rua do Socorro (atual Arlindo Fragoso), encurva-se à direita para encontrar-se com a estrada Dois de Julho (atual Vasco da Gama) na ``baixa ou largo da Fonte Nova'', onde dá lugar á rua do Sangradouro (atual Djalma Dutra). No lado contrário ao das ruas do Castro Neves e do Socorro encontram-se terrenos de Josepha Maria Leite, que atravessam a estrada Dois de Julho para o lado contrário ao da ladeira. Nota-se ainda, na entrada da rua do Sangradouro, uma ``fábrica de tecidos''.}
% \label{fig:joaquim01}
% \end{subfigure}
% \end{minipage}
\label{fig:joaquim}
...
\begin{figure}[!htp]
	...
	\centering
		\begin{subfigure}[b]{\textwidth}
			\includegraphics[width=1\textwidth]{3-cap2/complementos/imagens/1872-hospitalmilitar.jpg}
			\caption{\footnotesize O ``prédio nobre'' em 1872. (\textbf{Fonte:} \url{www.hges.eb.mil.br}.) }
			\label{fig:hospmil1872}
		\end{subfigure}
\  %espaco separador
		\begin{subfigure}[b]{\textwidth}
			\includegraphics[width=\textwidth]{3-cap2/complementos/imagens/1953-hospitalmilitar.jpg} 
...
\includegraphics[width=\textwidth]{3-cap2/complementos/mapas/georreferenciamento/boavista/boavista-sangradouro-1851-pronto.jpg}{\footnotesize \par \textbf{Fonte:} Recortado do mapa de \citeonline{weyll_mappa_1851}. \par \par No mapa de Weyll, da esquerda para a direita e partindo da ponta do Dique do Tororó, temos: \textbf{(a)} a Ladeira dos Galés; \textbf{(b)} uma bifurcação em ``Y'', cujo lado esquerdo corresponde à atual rua das Pitangueiras, que termina noutra bifurcação, cujo lado direito é a estrada da Quinta das Beatas (atual Cosme de Farias) e o lado esquerdo leva ao Matatu Pequeno (atual Vila Laura) e ao Matatu Grande (atual Matatu/Luiz Anselmo); \textbf{(c)} o ponto da bifurcação em ``Y'' que se separa da rua das Pitangueiras é o início da Estrada de Brotas (atual avenida D. João VI), num trecho que corresponde à atual avenida Frederico Costa, depois encontra uma bifurcação em ``T'' e segue adiante até a borda do mapa, na localidade indicada como ``Acu'' (atual Acupe de Brotas); \textbf{(d)} tomando a direita na bifurcação em ``T'', o caminho segue até um retângulo, que corresponde ao solar Boa Vista e ao Engenho Velho; \textbf{(e)} passado o retângulo que representa o solar Boa Vista, o caminho segue por uma trilha hoje inexistente, atravessa o rio Lucaia, segue por um vale (atual vale da Muriçoca) e encontra-se com a estrada do Rio Vermelho (atual avenida Cardeal da Silva).}
...
Quanto a esta fazenda, há uma curiosidade: em 2014 uma hospedaria chamada ``Morada Simão Mota'', situada em frente ao estádio da Fonte Nova, na Vila Santos, propagandeava em seu blog (\url{http://moradasimaomota.blogspot.com/}) ter sido o imóvel ``parte do Engenho Velho de Brotas'', mais especificamente a ``casa dos `negros' da fazenda'', onde ``os negros se reuniam para dormir ou fazer suas festas''. A afirmação dificilmente se comprova, mas o estilo arquitetônico do imóvel, ao menos, é compatível com o período escravagista (cf. \autoref{fig:2014-moradasimaomota}, p. \pageref{fig:2014-moradasimaomota}); se porventura for confirmada a história, trata-se talvez do segundo imóvel mais antigo do Engenho Velho, cedendo em antiguidade apenas para o próprio Solar Boa Vista.

\afterpage{
\begin{figure}
\caption{``Morada Simão Mota'', na atual rua Vila Santos de Baixo, no Engenho Velho de Brotas}
\centering
\includegraphics[height=\textwidth, angle=270]{3-cap2/complementos/imagens/2014-moradasimaomota.jpg}{\footnotesize \par \textbf{Fonte:} \url{http://moradasimaomota.blogspot.com/}. } 
...
\begin{a3paisagem}
\begin{figure}
\caption{Representação cartográfica parcial da estrada de Brotas e arredores (1851)}
\centering
\includegraphics[height=\textwidth, angle=270]{3-cap2/complementos/mapas/georreferenciamento/estbrotas/estbrotas-1851-pronto.jpg}{\footnotesize \par \textbf{Fonte:} recortada do mapa de \citeonline{weyll_mappa_1851}. \par A estrada de Brotas sai do canto esquerdo deste recorte, onde se encontra com a rua da Boa Vista, e serpenteia rumo à direita pela cumeada de morros. Passa por uma pequena aglomeração de imóveis no ``Acú'' (atual Acupe de Brotas), onde bifurca-se com uma pista que segue para baixo (atual ladeira do Acupe). Bifurca-se novamente na estrada da Cruz das Almas (atual avenida Waldemar Falcão), que segue para baixo. Continua por um trecho mais largo (o largo de Brotas, hoje inexistente), onde se nota a representação da igreja de Brotas. Daí segue até um largo marcado com uma cruz (atual largo da Cruz da Redenção), onde divide-se em três caminhos. O caminho que vai para cima dá nos engenhos Campina Grande e Campina Pequena (situados onde hoje ficam o Abrigo Salvador e o cemitério Jardim da Saudade). O caminho que vai para baixo corresponde à estrada das Ubaranas (atual ladeira da Cruz da Redenção). A estrada de Brotas termina aqui, mas o caminho segue para a direita com o nome de estrada das Armações, ou estrada do Beiju (atual rua Teixeira Mendes).} 
...
\begin{a3paisagem}
\begin{figure}
\caption{Representação cartográfica atual da avenida D. João VI e arredores (2016)}
\centering
\includegraphics[width=\textwidth]{3-cap2/complementos/mapas/georreferenciamento/estbrotas/estbrotas-2016.jpg}{\footnotesize \par \textbf{Fonte:} elaboração do autor, usando a base cartográfica do Open Street Maps.}
...
\begin{a3paisagem}
\begin{figure}
\caption{Representação cartográfica do rio Lucaia e seus arredores (1851)}
\centering
\includegraphics[height=0.9\textheight]{3-cap2/complementos/mapas//georreferenciamento/e2j/e2j-1851-pronto.jpg}{\footnotesize \par \textbf{Fonte:} recortada do mapa de \citeonline{weyll_mappa_1851}. \par A estrada Dois de Julho foi construída em 1855 margeando o rio Lucaia como mais uma alternativa para chegar ao arrabalde veranista do Rio Vermelho.}
\label{fig:e2j-1851}
\end{figure}
\end{a3paisagem}
}
...
\begin{a3paisagem}
\begin{figure}
\caption{Representação cartográfica da atual avenida Vasco da Gama e seus arredores}
\centering
\includegraphics[height=0.9\textheight]{3-cap2/complementos/mapas/georreferenciamento/e2j/e2j-2016.jpg}{\par footnotesize \textbf{Fonte:} elaboração do autor, usando a base cartográfica do Open Street Maps.}
\label{fig:e2j-hoje}
\end{figure}
\end{a3paisagem}
 }
...
\centering
\includegraphics[height=\textwidth, angle=270]{3-cap2/complementos/imagens/1872-e2j.jpg}{\footnotesize \par \textbf{Fonte:} INCLUIR A FONTE } 
\label{fig:1872-e2j}
\end{figure}
}
...
\centering
\includegraphics[height=\textwidth, angle=270]{3-cap2/complementos/imagens/1870-bonderiovermelho.jpg}{\footnotesize \par \textbf{Fonte:} INCLUIR A FONTE \par Na falta de outras indicações, a mata frondosa e o terreno em aclive sugerem que se trata da linha de bonde da empresa Trilhos Centrais, que passava pela estrada Dois de Julho.} 
...
\begin{a3paisagem}
\begin{figure}
\caption{Representação cartográfica da povoação da Mariquita e seus arredores (1851)}
\centering
\includegraphics[height=0.9\textheight]{3-cap2/complementos/mapas//georreferenciamento/mariquita/mariquita-1851-pronto.jpg}{\footnotesize \par \textbf{Fonte:} recortada do mapa de \citeonline{weyll_mappa_1851}. \par A Mariquita é uma fieira de quadrados pretos ao pé do ``Monte Concelho'' (atual morro do Conselho). Há um pequeno espelho d'água de onde corre um filete até perto da foz do Lucaia; este filete é o riacho do Boi, e o espelho d'água fica onde hoje se situa a rua da Fonte do Boi.}
\label{fig:mariquita-1851}
\end{figure}
\end{a3paisagem}
}
...
\begin{a3paisagem}
\begin{figure}
\caption{Representação cartográfica do largo da Mariquita e seus arredores}
\centering
\includegraphics[height=0.9\textheight]{3-cap2/complementos/mapas/georreferenciamento/mariquita/mariquita-2016.jpg}{\par \footnotesize \textbf{Fonte:} elaboração do autor, usando a base cartográfica do Open Street Maps.}
\label{fig:mariquita-hoje}
\end{figure}
\end{a3paisagem}
 }
...
\begin{a3paisagem}
\begin{figure}[!htp]
\caption{Representação cartográfica parcial da Casa da Pólvora, do Matatu Grande e da Quinta das Beatas e arredores (1851)}
\centering
\includegraphics[height=0.9\textheight]{3-cap2/complementos/mapas/georreferenciamento/matatu/matatu-1851-pronto.jpg}{\footnotesize \par \textbf{Fonte:} recortada do mapa de \citeonline{weyll_mappa_1851}. \par Da esquerda para a direita estão o rio Santo Antônio, o córrego das Beatas e o rio Bonocô; os dois primeiros são hoje canais de esgoto, e o terceiro corre sob o canteiro central da avenida Mário Leal Ferreira (Bonocô). Na margem esquerda do mapa corre a rua da Vala, num trecho que corresponde à atual Via Expressa/Heitor Dias.}
...
\begin{a3paisagem}
\begin{figure}
\caption{|Representação cartográfica parcial da Vila Laura, do Matatu/Luiz Anselmo e de Cosme de Farias}.
\centering
\includegraphics[height=0.9\textheight]{3-cap2/complementos/mapas/georreferenciamento/matatu/matatu-2016.jpg}{\footnotesize \par \textbf{Fonte:} elaboração do autor, usando a base cartográfica do Open Street Maps.}
...
\centering
\includegraphics[width=0.9\textheight, angle=270]{3-cap2/complementos/mapas/georreferenciamento/acupe/acupe-1851-pronto.jpg}{\footnotesize \par \textbf{Fonte:} retirada do mapa de \citeonline{weyll_mappa_1851}. \par O Acupe está à esquerda (``Acú''), e à direita está a estrada das Ubaranas (atual ladeira da Cruz da Redenção). Note-se, mais à direita, o largo de Brotas.}
\label{fig:acupe1851}
\end{figure}
\end{a3paisagem}
}
...
\centering
\includegraphics[height=0.9\textheight]{3-cap2/complementos/mapas/georreferenciamento/acupe/acupe-2016.jpg}{\footnotesize \par \textbf{Fonte:} Elaboração do autor com imagem do Open Street Maps. Respeitou-se o traçado de \citeonline{weyll_mappa_1851}. \par}
\label{fig:acupe2016}
\end{figure}
\end{a3paisagem}
}
...
\begin{a3paisagem}
\begin{figure}
\caption{Representação cartográfica parcial das fazendas Campina Grande e Campinas Pequena (1851).}
\centering
\includegraphics[height=0.8\textheight]{3-cap2/complementos/mapas/georreferenciamento/campinas/campinas-1851-pronto.jpg}{\footnotesize \par \textbf{Fonte:} \citeonline{weyll_mappa_1851}. \par O ``Engº'' do mapa é a fazenda Campina Grande, e na cumeada próxima fica a fazenda Campina Pequena.}
...
\centering
\includegraphics[width=0.8\textwidth]{3-cap2/complementos/mapas/georreferenciamento/campinas/campinas-2016.jpg}{\footnotesize \par \textbf{Fonte:} Elaboração do autor com imagem do Open Street Maps. Respeitou-se o traçado de \citeonline{weyll_mappa_1851}. \par}
...
Ocorre que o caminho descrito no mapa de \citeonline{weyll_mappa_1851} parece ser outro bem diferente\footnote{Com a base documental pesquisada até o momento é impossível descrever precisa e minuciosamente as ruas remanescentes desta estrada, e é possível mesmo que tal descrição documental sequer exista; a reconstituição desta estrada exigiria uma pesquisa \textit{in loco} com antigos moradores da Santa Cruz e do Nordeste de Amaralina para tentar recompor alguns traços perdidos desta estrada, profundamente modificada pela ocupação popular do território destes bairros, pelos loteamentos resultantes nos bairros de Amaralina e Pituba, e pela construção da avenida Juracy Magalhães e do Parque da Cidade.}. Se seguirmos o trajeto desenhado no mapa de Weyll desde o largo da Cruz da Redenção até a atual praça dos Veteranos em Amaralina (onde se situava a Armação da Lagoa) e o compararmos com o trajeto de ruas atuais (cf. figura \autoref{fig:armacaodalagoa-hoje}, p. \pageref{fig:armacaodalagoa-hoje}), é plausível conceber alguns possíveis caminhos remanescentes da velha estrada da Ubarana:
...
É da fazenda Alagoa que deriva o loteamento, do final do século XIX, chamado \textit{Cidade Balneária Amaralina}, a ser detalhado no capítulo seguinte.
...
\centering
\includegraphics[width=\textwidth]{3-cap2/complementos/mapas/georreferenciamento/amaralina/armacaodalagoa-1851-pronto.jpg}{\footnotesize \par \textbf{Fonte:} \citeonline{weyll_mappa_1851}. Observe-se a quase total ausência da representação cartográfica usada por Carlos Weill para indicar habitações (quadriláteros pretos), e igualmente a quase total ausência de vias. \par}
...
\centering
\includegraphics[height=0.9\textheight]{3-cap2/complementos/mapas/georreferenciamento/amaralina/armacaodalagoa-2016.jpg}{\footnotesize \par \textbf{Fonte:} Elaboração do autor com imagem do Open Street Maps. Respeitou-se o traçado de \citeonline{weyll_mappa_1851}. \par}
...
\input{3-cap2/complementos/tabelas/decurb-1886-1891}
...
\input{3-cap2/complementos/tabelas/compara-brotas}
