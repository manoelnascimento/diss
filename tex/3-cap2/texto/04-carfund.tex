...
\begin{a3paisagem}
\begin{figure}
\caption{Folha 32 do \textbf{Atlas parcial da cidade do Salvador}, contando descrição cartográfica parcial do Engenho Velho de Brotas.}
\centering
\includegraphics[height=0.9\textheight]{3-cap2/complementos/mapas/engvelho1955-1.jpg}{\footnotesize \par \textbf{Fonte:} \citeonline{municipal_atlas_1955}. \par O Engenho Velho de Brotas é a elevação ao centro do mapa, acima do Dique do Tororó. Na versão impressa do mapa, que perdeu nitidez na digitalização, percebe-se nesta descrição cartográfica de 1955 toda a malha viária do Engenho Velho, correspondente a vias e localidades já existentes na Primeira República.}
